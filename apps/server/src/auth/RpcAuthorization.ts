...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.foundryIngestApprovedContract]: AuthOrchestrationOperateScope,
  [WS_METHODS.foundryClaimDispatch]: AuthOrchestrationOperateScope,
  [WS_METHODS.foundryHeartbeatDispatch]: AuthOrchestrationOperateScope,
  [WS_METHODS.foundryReportDispatch]: AuthOrchestrationOperateScope,
  [WS_METHODS.foundryGetDispatch]: AuthOrchestrationReadScope,
